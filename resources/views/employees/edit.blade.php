                        ...
                        <form method="post" action="/employees/{{$employee->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error ('nama_depan')  is-invalid @enderror" id="nama_depan"
                                       placeholder="Nama Depan" name="nama_depan" value="{{$employee->nama_depan}}">
                                @error('nama_depan')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error ('nama_belakang')  is-invalid @enderror" id="nama_belakang"
                                       placeholder="Nama Belakang" name="nama_belakang" value="{{$employee->nama_belakang}}">
                                @error('nama_belakang')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error ('tanggal_lahir')  is-invalid @enderror"
                                       id="tanggal_lahir" name="tanggal_lahir" value="{{$employee->tanggal_lahir}}">
                                @error('tanggal_lahir')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error ('nomer_hp')  is-invalid @enderror" id="nomer_hp"
                                       placeholder="Nomer HP" name="nomer_hp" value="{{$employee->nomer_hp}}">
                                @error('nomer_hp')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
