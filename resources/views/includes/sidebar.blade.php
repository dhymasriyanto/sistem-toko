<nav id="sidebar" class="sidebar">
    <div class="sidebar-content ">
        <a class="sidebar-brand" href="{{url('/')}}">
            <img src="{{asset('/appstack/img/brands/logo.png')}}" class="rounded-circle" alt="Logo" width="30"
                 height="30">
        ...
        <ul class="sidebar-nav">
            ...
            @if(Auth::user()->level_akses=='Pemilik Toko')
                ...
                <li class="sidebar-item ">
                    ...
                    <ul id="persediaan" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                        <li class="sidebar-item {{ Request::is('stuffs')  ? 'active' : '' }}"><a class="sidebar-link"
                                                                                                 href="{{url('/stuffs')}}">Inventori</a>
                        </li>
                        <li class="sidebar-item {{ Request::is('categories')  ? 'active' : '' }}"><a
                                class="sidebar-link" href="{{url('/categories')}}">Kategori</a></li>
                        <li class="sidebar-item {{ Request::is('units')  ? 'active' : '' }}"><a class="sidebar-link"
                                                                                                href="{{url('/units')}}">Satuan</a>
                        </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="transaksi" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item {{ Request::is('in-transactions')  ? 'active' : '' }}"><a
                            class="sidebar-link" href="{{url('/in-transactions')}}">Transaksi Masuk</a></li>
                    <li class="sidebar-item {{ Request::is('out-transactions')  ? 'active' : '' }}"><a
                            class="sidebar-link" href="{{url('/out-transactions/create')}}">Transaksi Keluar</a></li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="riwayat" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item {{ Request::is('histories')  ? 'active' : '' }}"><a class="sidebar-link"
                                                                                                href="{{url('/histories')}}">Riwayat
                            Transaksi</a></li>
                    <li class="sidebar-item {{ Request::is('debt-histories')  ? 'active' : '' }}"><a
                            class="sidebar-link" href="{{url('/debt-histories')}}">Riwayat Hutang</a></li>
